...
public class CopyOfGooglePayComponent extends Component {
	private static String TAG = CopyOfGooglePayComponent.class.getSimpleName();
	...
	public CopyOfGooglePayComponent(String base64EncodedPublicKey){
