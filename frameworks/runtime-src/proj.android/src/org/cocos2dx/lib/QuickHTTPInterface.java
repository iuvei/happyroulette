...
public class QuickHTTPInterface {
    ...
    public static void initHttpsURLConnection(){
    	try{
		    ...
		    Log.e("QuickHTTPInterface","init HttpsURLConnection");
		}catch(Exception e){
			Log.e("QuickHTTPInterface initHttpsURLConnection",e.toString());
		}
    ...
    static HttpURLConnection createURLConnect(String strURL) {
        ...
        try {
            ...
            Log.e("QuickHTTPInterface createURLConnect", e.toString());
            return null;
        }
    ...
    static void setRequestMethod(HttpURLConnection http, String strMedthod) {
        try {
            ...
            Log.e("QuickHTTPInterface setRequestMethod", "strMedthod = "+strMedthod);
            http.setRequestMethod(strMedthod);
        } catch (ProtocolException e) {
            Log.e("QuickHTTPInterface setRequestMethod", e.toString());
        }
    }
    ...
    static int connect(HttpURLConnection http) {
        ...
        try {
            ...
            Log.e("QuickHTTPInterface connect", e.toString());
            nSuc = 1;
        }
    ...
    static void postContent(HttpURLConnection http, String name, String value, boolean bNeedConnectSym) {
        try {
            ...
            Log.e("QuickHTTPInterface postContent", e.toString());
        }
    }
    ...
    static void postContentByteArray(HttpURLConnection http, byte[] byteArray) {
        try {
            ...
            Log.e("QuickHTTPInterface postContentByteArray", e.toString());
        }
    }
    ...
    static void postFormContent(HttpURLConnection http, String key, String val) {
        try {
            ...
            Log.e("QuickHTTPInterface postFormContent", e.toString());
        }
    }
    ...
    static void postFormFile(HttpURLConnection http, String name, String filePath) {
        try {
            ...
            Log.e("QuickHTTPInterface postFormFile", e.toString());
        }
    }
    ...
    static void postFormEnd(HttpURLConnection http, boolean bBoundary) {
        ...
        try {
            ...
            Log.e("QuickHTTPInterface postFormEnd", e.toString());
        }
    }
    ...
    static int getResponedCode(HttpURLConnection http) {
        ...
        try {
            ...
            Log.e("QuickHTTPInterface getResponedCode", e.toString());
        }
        return code;
    }
    ...
    static String getResponedErr(HttpURLConnection http) {
        ...
        try {
            ...
            msg = e.toString();
            Log.e("QuickHTTPInterface getResponedErr", msg);
        }
    ...
    static String getResponedHeader(HttpURLConnection http) {
        ...
        try {
            ...
            Log.e("QuickHTTPInterface getResponedHeader", e.toString());
        }
    ...
    static byte[] getResponedString(HttpURLConnection http) {
        try {
            ...
            Log.e("QuickHTTPInterface getResponedString", e.toString());
        }
    ...
    static void close(HttpURLConnection http) {
    	try {
			Log.d("QuickHTTPInterface close", "getResponseCode = " + http.getResponseCode());
        ...
        try {
            ...
            Log.e("QuickHTTPInterface close", e.toString());
        }
    }
